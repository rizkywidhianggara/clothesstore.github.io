...
<br>
<center><h3>Master Customer di ClothesStore</h3></center>
...
<div class="container">
  <a class="btn btn-success" href="input_customer.php">Tambah Data Customer</a>
  <table class="table table-dark">
    ...
    <tr>
      ...
      <td>
      <a href="edit_customer.php?id_customer=<?php echo $data['id_customer']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      <a href="hapus_customer.php?id_customer=<?php echo $data['id_customer']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>
      </td>
    </tr>
    <?php } ?>
    </div>
